...
function Home() {
    ...
    return (
        <>
            <Helmet>
                <title>Home | SBI Life Insurance</title>
                {/* <link rel="icon" type="image/x-icon" href="/favicon.ico" /> */}
            </Helmet>
            <div className="bg-gray-50 min-h-screen relative max-w-screen pt-24">
                <AnimatedGridPattern />
                ...
                <div className="App relative z-10">
                    ...
                    <main className="main-content container mx-auto py-12 px-6">
                        ...
                        >
                            ...
                            <h1 className="text-6xl font-extrabold mb-6  drop-shadow-xl">Welcome to AI Life Insurance Advisor</h1>

                            <p className="text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
                                An AI-powered life insurance advisor that helps you make informed decisions for SBI life insurance policies.
                            </p>
                            <motion.a
                        ...
                        <section id="team" className="contact-section bg-white shadow-lg rounded-lg p-8 my-12">
                            <AnimatedGradientText className="text-3xl font-bold text-center mb-6">
                                Team
                            </AnimatedGradientText>
